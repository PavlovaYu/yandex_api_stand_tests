...
# Тест 3. Недопустимое создание пользователя
# Параметр fisrtName состоит из 1 символа
def test_create_user_1_letter_in_first_name_get_error_response():
    negative_assert_symbol("А")

# Тест 4. Недопустимое создание пользователя
...
# Тест 12. Ошибка
# Параметр fisrtName состоит из недопустимого типа данных - чисел
